<?php
/**
 * Template Name: Tables Page with 3 Columns
 *
    ...
    <div class="container">
		<div class="row">
			<div class="col-sm-12 offset-sm-0 col-md-8 offset-md-2">
				<?php the_field('three_column_text_area'); ?>
			</div>
		</div>
	</div>
	<div class="container" id="content" tabindex="-1">
		<div class="row">
            <table class="table table-striped">
                <thead>
                    <tr>
                        <th scope="col"><?php the_field( 'heading_one' );?></th>
                        <th scope="col"><?php the_field( 'heading_two' );?></th>
                        <th scope="col"><?php the_field( 'heading_three' );?></th>
                    </tr>
                </thead>
